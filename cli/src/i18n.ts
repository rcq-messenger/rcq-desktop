...
`,
  ...
  'block.listHint': {
    en: 'blocked off-island, on this device only. rcq unblock <uin>@<island> takes one back off.',
    ru: 'заблокированы на других островах, только на этом устройстве. rcq unblock <uin>@<остров> снимает.',
    es: 'bloqueados fuera de la isla, solo en este dispositivo. rcq unblock <uin>@<isla> lo quita.',
    pt: 'bloqueados fora da ilha, só neste aparelho. rcq unblock <uin>@<ilha> remove.',
    tr: 'ada disinda engellenenler, yalnizca bu cihazda. rcq unblock <uin>@<ada> geri alir.',
    uk: 'заблоковані на інших островах, лише на цьому пристрої. rcq unblock <uin>@<острів> знімає.',
    'zh-Hans': '仅在本设备上被屏蔽的岛外用户。用 rcq unblock <uin>@<岛> 取消。',
  },
  'block.listEmpty': {
    en: 'nobody blocked off-island on this device',
    ru: 'на других островах здесь никто не заблокирован',
    es: 'nadie bloqueado fuera de la isla en este dispositivo',
    pt: 'ninguém bloqueado fora da ilha neste aparelho',
    tr: 'bu cihazda ada disinda engellenen kimse yok',
    uk: 'на інших островах тут нікого не заблоковано',
    'zh-Hans': '本设备上没有屏蔽任何岛外用户',
  },
  'block.doneLocal': {
    en: '{who} blocked on this device. Their island is not told, and this list does not follow you to another device.',
    ru: '{who} заблокирован на этом устройстве. Их острову об этом не сообщают, и на другое ваше устройство список не переедет.',
    es: '{who} bloqueado en este dispositivo. Su isla no se entera, y esta lista no viaja a otro dispositivo tuyo.',
    pt: '{who} bloqueado neste aparelho. A ilha dele não é avisada, e esta lista não vai para outro aparelho seu.',
    tr: '{who} bu cihazda engellendi. Adasina haber verilmez ve bu liste baska cihaziniza gecmez.',
    uk: '{who} заблокований на цьому пристрої. Їхньому острову не повідомляють, і на інший ваш пристрій список не переїде.',
    'zh-Hans': '已在本设备上屏蔽 {who}。不会通知对方所在的岛，这份名单也不会同步到你的其他设备。',
  },
  'block.undoneLocal': {
    en: '{who} unblocked on this device',
    ru: '{who} разблокирован на этом устройстве',
    es: '{who} desbloqueado en este dispositivo',
    pt: '{who} desbloqueado neste aparelho',
    tr: '{who} bu cihazda engeli kaldirildi',
    uk: '{who} розблокований на цьому пристрої',
    'zh-Hans': '已在本设备上取消屏蔽 {who}',
  },
  'block.alreadyOn': {
    en: '{who} was already blocked', ru: '{who} и так был заблокирован',
    es: '{who} ya estaba bloqueado', pt: '{who} já estava bloqueado',
    tr: '{who} zaten engelliydi', uk: '{who} і так був заблокований',
    'zh-Hans': '{who} 本来就已被屏蔽',
  },
  'block.alreadyOff': {
    en: '{who} was not blocked', ru: '{who} и не был заблокирован',
    es: '{who} no estaba bloqueado', pt: '{who} não estava bloqueado',
    tr: '{who} engelli degildi', uk: '{who} і не був заблокований',
    'zh-Hans': '{who} 并未被屏蔽',
  },
  'block.needsUin': {
    en: 'block needs a numeric UIN, or <uin>@<island> for somebody on another island',
    ru: 'block ждёт числовой UIN или <uin>@<остров> для человека с другого острова',
...
在半行输入时按 Ctrl+C 会丢弃该行, 而不是结束会话。`,
  ...
  'update.noSignature': {
    en: 'this release has no signature next to it; refusing to install it',
    ru: 'у этого релиза рядом нет подписи, ставить его не буду',
    es: 'esta versión no tiene firma al lado; no la voy a instalar',
    pt: 'esta versão não tem assinatura ao lado; não vou instalar',
    tr: 'bu surumun yaninda imza yok; kurmayacagim',
    uk: 'у цього релізу поруч немає підпису, встановлювати не буду',
    'zh-Hans': '这个版本旁边没有签名，拒绝安装',
  },
  'update.badSignature': {
    en: 'the signature does not match the archive. Somebody served you a different file: nothing was installed',
    ru: 'подпись не сходится с архивом. Вам отдали другой файл: ничего не установлено',
    es: 'la firma no coincide con el archivo. Te sirvieron otro fichero: no se instaló nada',
    pt: 'a assinatura não confere com o arquivo. Serviram outro ficheiro: nada foi instalado',
    tr: 'imza arsivle uyusmuyor. Size baska bir dosya verildi: hicbir sey kurulmadi',
    uk: 'підпис не сходиться з архівом. Вам віддали інший файл: нічого не встановлено',
    'zh-Hans': '签名与压缩包不符。有人给了你另一个文件：未安装任何内容',
  },
  'update.unknown': {
