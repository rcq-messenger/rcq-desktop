...
export const en: Record<string, string> = {
  ...
  'invites.free': 'You were here before residency: the island still gives you invites, one a month.',
  'residency.title': 'Residency',
  'residency.since': 'Resident since {date}',
  'residency.body': 'One payment, once. A resident gets invites to hand out, one a month, and wears the island\'s mark.',
  'residency.buy': 'Buy · {price}',
  'residency.buy_on': 'Buy on {host}',
  'residency.have_code': 'I have a code',
  ...
  'login.create.residency_no_url': 'Residency here costs {price}, but this island does not say where it is sold. Its operator hands out the codes.',
