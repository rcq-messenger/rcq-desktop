...
export const en: Record<string, string> = {
  ...
  'invites.free': 'You were here before residency: the island still gives you access codes to hand out, one a month.',
  'residency.title': 'Residency',
  'residency.since': 'Resident since {date}',
  'residency.body': 'One payment, once. A resident gets access codes to hand out, one a month, and wears the island\'s mark.',
