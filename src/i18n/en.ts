...
export const en: Record<string, string> = {
  ...
  'poll.create.question_placeholder': 'What are you asking?',
  'poll.create.options': 'Options',
  'poll.create.option': 'Option {n}',
  'poll.create.add_option': 'Add option',
  'poll.create.remove_option': 'Remove option',
  'poll.create.single': 'Single choice',
  'poll.create.single.hint': 'Everyone picks one option. Off, they can pick several.',
  'poll.create.anon': 'Anonymous',
  'poll.create.anon.hint': 'Only the counts are shown, never who voted for what.',
  'poll.create.cta': 'Create',
