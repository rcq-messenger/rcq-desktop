...
export const en: Record<string, string> = {
  ...
  "badge.desc.official": "Official account, confirmed by this island: its team, or a source the island vouches for.",
  "badge.desc.tester": "Tester. Took part in testing and helped find what was broken.",
  "badge.desc.special": "Given by this island for an outstanding contribution.",
  'badge.resident': 'Resident',
  'badge.desc.resident': 'You paid to join this island, so you live here.',
  ...
  'island.entry.price': '{price} once',
  'island.entry.closed': 'Closed club',
  'island.entry.invite': 'Access code only',
  'island.entry.open': 'Open to everyone',
  'island.entry.buy': 'buy',
  'invites.free': 'You were here before residency: the island still gives you access codes to hand out.',
  'residency.title': 'Residency',
  'residency.since': 'Resident since {date}',
  'residency.body': 'One payment, once. A resident wears the island\'s mark; what else residency carries here, access codes to hand out among them, is the operator\'s decision.',
  'residency.buy': 'Buy · {price}',
  'residency.buy_on': 'Buy on {host}',
  'residency.have_code': 'I have an access code',
  'residency.redeem': 'Activate',
  'residency.redeeming': 'Checking…',
  'residency.done': 'You live here now.',
  'residency.already': 'This account is already a resident.',
  'residency.code_spent': 'That code has already been used.',
  'residency.not_sold': 'This island does not sell residency.',
  'residency.invalid': 'That code was not accepted. It may be used up, expired, or meant for another island.',
  'residency.error': 'The island did not accept it. Try again.',
  'login.create.buy_entry_hint_inapp': 'You pay in crypto right here. The access code lands in the box below by itself.',
  'entry_checkout.title': 'Residency on {island}',
  'entry_checkout.seller_rcq': 'Sold by the RCQ team.',
  'entry_checkout.seller_operator': 'Sold by {island} ({host}), the operator of this island.',
  'entry_checkout.refund': 'One-off, not a subscription: refundable while the code is unused, and once it has been redeemed there is nothing left to return. The amount is quoted at the rate of the moment; the rate moving between payment and refund is not compensated.',
  'entry_checkout.refund_link': 'Refund policy',
  'entry_checkout.refund_operator': 'Refunds are the operator’s decision: ask them before paying.',
  'entry_checkout.not_for_sale': 'Entry to this island is not on sale right now.',
  'entry_checkout.paid': 'Paid. Your access code is ready.',
  'island.rules.title': 'House rules',
  'island.back_to_list': 'Back to the list',
  'island.use': 'Use this island',
  'island.picker.prev': 'Previous island',
  'island.picker.next': 'Next island',
  'island.picker.dot': 'Island {n} of {total}',
  'island.remembered': 'Remembered',
  'island.forget': 'Forget this island',
  'island.gateway_key': 'Gateway key',
  'island.gateway_key_hint': 'For a private island behind a gateway. The key stays on this computer and is sent only to that island.',
  'island.gateway_key_bad': 'The island did not accept this key.',
  'island.gateway_key_on_file': 'Gateway key on file',
  'invites.title': 'Access codes',
  'invites.next': 'Your next one arrives {date}',
  'invites.all': 'You are holding all of them',
  'invites.mint': 'Create an access code',
  'invites.minting': 'Creating…',
  'invites.copy': 'Copy the link',
  'invites.copied': 'Copied',
  'invites.once': 'Shown once. Copy it now: the island keeps only a fingerprint of the code, not the code.',
  ...
  // (docs/island-fingerprint-design.md §5). {fp} is drawn as its own block.
  'island.trust.first_use': 'First connection to {host}. Its fingerprint is {fp}. Compare it with what the operator published before you rely on this island.',
  'island.trust.changed': '{host} presented a different certificate than the one this device trusts. Someone may be intercepting the connection, or the operator replaced the certificate. Compare the new fingerprint with what the operator published before trusting it.',
  'island.trust.changed_typed': '{host} presented a different fingerprint than the one you entered.',
  ...
  'island.trust.settings.ca': 'Trusted by certificate',
  'island.trust.settings.pinned': 'Trusted by fingerprint',
  'island.trust.settings.footer': 'How this device decided to trust this island. An island without a certificate authority is trusted by the fingerprint of its own certificate instead.',
  'island.trust.copy': 'Copy address with fingerprint',
  'island.trust.browser_hint': 'An island without a certificate authority opens in the desktop and phone apps, not in a browser.',
  ...
  'login.create.buy_residency': 'Buy residency · {price}',
  'login.create.residency_no_url': 'Residency here costs {price}, but this island does not say where it is sold. Its operator hands out the access codes.',
  'auth.error.invite_required': 'This island is closed: joining needs an access code from its operator. Paste it above.',
  'auth.error.entry_required': 'Entry to this island is paid. Buy entry, then paste the code you get above.',
  ...
  'login.terms.island_accept': 'I accept',
  'login.terms.island_rules': 'the rules of this island',
  'login.terms.island_no_rules': 'I accept that this island sets its own rules, and its operator has not linked them here.',
  'login.terms.island_operator': 'This island is run by its operator, not the RCQ team: they decide its rules and what it keeps about you.',
  ...
  "report.body": "Tell the island what is wrong. The operator reads this; the person you report does not.",
  "report.placeholder": "What happened",
  ...
  'err.island_busy': 'The island is busy. Your message is kept; try again in a moment.',
  'err.no_connection': 'No connection. Your message is kept and will go when you are back.',
  'err.busy_rate': 'Too fast. Give it a few seconds.',
  'err.not_allowed': 'This island did not accept that.',
  'err.no_session': 'Still signing in to the island. Give it a moment, it will finish on its own.',
  'err.too_big': 'Too large to send.',
  'err.gone': 'That is no longer there.',
  'err.rejected': 'The island refused that.',
  'err.unknown': 'That did not go through.',
  ...
  'chat.location.confirm.title': 'Send your location?',
  'chat.location.confirm.body': 'Your current coordinates will be sent to {who} as a message. You can delete it afterwards, but not unsee it.',
  'chat.location.confirm.send': 'Send location',
  ...
  'chat.actions.open_site': 'Open the site',
  ...
  'sites.publish.title': 'One line for the catalogue',
  'sites.publish.icon.found': 'Mark: {file} (shown beside the address)',
  'sites.publish.icon.converted': '{file} was turned into icon.png: the phones cannot decode it, so the network carries PNG.',
  'sites.publish.icon.none': 'No mark. Add icon.png (or icon.webp) and it shows beside the address. A picked .svg or .ico is converted for you.',
  'sites.publish.pick': 'Choose files',
  'sites.publish.mark': 'Mark',
  'sites.publish.mark.pick': 'Choose a picture',
  ...
  'sites.publish.rename': 'Change the address',
  ...
  'sites.publish.rules': 'HTML, CSS and pictures (png, jpg, gif, webp, svg). One file must be index.html, and icon.png becomes the site mark. Up to 64 files, 5 MB each, 20 MB in total. No scripts: nothing in a page runs, and nothing loads from outside the network.',
  ...
  'sites.publish.cta': 'Publish',
  'sites.publish.update': 'Publish a new version',
  'sites.publish.busy': 'Publishing…',
  'sites.publish.version': 'version {n}',
  'sites.publish.delete': 'Delete the site',
  ...
  'sites.publish.delete.confirm': 'Delete',
  'sites.publish.error.failed': 'The island did not take it.',
  'sites.publish.error.rate_limited': 'Too many publishes for now. Try again later.',
  ...
  'sites.loading': 'Opening…',
  'sites.catalogue': 'On your island',
  'sites.pinned': 'Pinned',
  'sites.recents': 'Recent',
  'sites.recents.remove': 'Remove from the list',
  'sites.share': 'Share the address',
  'sites.share.copy': 'Copy the address',
  'sites.external.title': 'Leaving RCQ',
  'sites.external.body': 'This link goes out to the ordinary web, outside the network. Your browser opens it, and whoever runs that address will see the visit.',
  'sites.external.remember': 'Do not ask again',
  'sites.external.open': 'Open',
  'sites.share.title': 'Send the address to',
  'sites.by': 'by',
  'sites.error.unsigned': 'The signature on this site does not check out. Nothing was shown.',
  'sites.error.tampered': 'A file does not match what the owner signed. Nothing was shown.',
  'sites.error.offline': 'Could not reach that island.',
  'sites.key_changed.accept': 'Trust the new key',
  'sites.nav': 'Sites (.rcq)',
  'sites.back': 'Back',
  ...
  'sites.empty.title': 'Pages inside the network',
  'sites.empty.body': 'Type an address, for example blog.rcq. Pages are text and pictures only: no scripts, no outward links, nothing loaded from outside.',
  'sites.key_changed': 'This site is signed by a different key than the last time you opened it.',
  ...
  'report.attach.add': 'Attach a screenshot',
  'report.attach.remove': 'Remove attachment',
  'report.attach.error': 'Could not upload the attachment. Nothing was sent; your text is still here, try again.',
  'myreports.attach_dropped': 'Your text was added, but this island did not keep the picture. Send it as a new report.',
  ...
  'profile.cta.add_contact': 'Add to contacts',
  ...
  'settings.privacy.badge_pick': 'Which mark to wear',
  'settings.privacy.badge_pick_desc': 'You hold more than one. Only the one you pick shows beside your name.',
  ...
  'settings.sound.presence': 'Sound when a contact comes online or leaves',
  'settings.sound.presence_footer': 'Everyone plays a tone for any contact. Favourites plays only for the people you starred. Off never plays one. Groups are never announced here: this is about your contacts.',
  'settings.section.theme': 'Theme',
  'settings.sound.presence_all': 'Everyone',
  'settings.sound.presence_favorites': 'Favourites',
  'settings.sound.presence_off': 'Off',
  'settings.sound.presence_leave': 'Also play it when they leave',
  'settings.sound.presence_leave_footer': 'Off keeps the tone for somebody arriving and drops the one for somebody leaving.',
  'settings.sound.presence_try_online': 'Play the arrival tone',
  'settings.sound.presence_try_offline': 'Play the departure tone',
  ...
  'uin_market.cta.buy_short': 'Buy',
  'uin_market.cta.buy': 'Get for {price}',
  'uin_market.cta.take': 'Take it',
  'uin_market.cta.resume': 'Finish paying',
  ...
  'uin_market.people.refresh': 'Show others',
  'uin_market.people.held': 'someone is paying',
  ...
  'uin_market.tiers.free': 'free',
  'uin_checkout.pick.body': 'Pick what you are paying with. Nothing to sign up for: you send an exact amount, and that amount is what identifies the payment.',
  'uin_checkout.pay.body': 'Send exactly this amount in {chain}.',
  'uin_checkout.paid.body': 'Payment received. Taking the number…',
  'uin_checkout.amount': 'Amount',
  'uin_checkout.address': 'Address',
  'uin_checkout.copy': 'Copy',
  'uin_checkout.copied': 'Copied',
  ...
  'uin_checkout.error.busy': 'Too many numbers are being bought at once. Try again in a few minutes.',
  'uin_checkout.error.generic': 'Could not start the payment. Try again.',
