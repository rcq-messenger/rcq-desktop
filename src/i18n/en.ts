...
export const en: Record<string, string> = {
  ...
  'storage.pin.on': 'set — the account is sealed here',
  ...
  'pin.off.body': 'Locks the app and takes your account off this disk: the keys, the recovery phrase and the session are sealed with your PIN and cannot be read without it — not while the app is closed, not by anyone who opens this laptop.\nThe message history is not sealed yet. That is the next piece, and until it is done a locked app still has readable conversations on this disk.',
  'pin.on.body': 'The app is locked with a PIN. Your account is sealed on this disk and comes back only when you type it.\nThe message history is not sealed yet.',
  'pin.set': 'Set a PIN',
