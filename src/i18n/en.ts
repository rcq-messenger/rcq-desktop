...
export const en: Record<string, string> = {
  ...
  'sites.publish.icon.converted': '{file} was turned into icon.png: the phones cannot decode .ico, so the network carries PNG.',
  'sites.publish.icon.none': 'No mark. Add icon.png or icon.svg and it shows beside the address.',
