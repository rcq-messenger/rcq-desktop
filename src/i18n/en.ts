...
export const en: Record<string, string> = {
  ...
  'settings.devices.primary': 'First device',
  ...
  'settings.devices.revoke_cooldown': 'A session younger than 24 hours cannot revoke older ones. Available again in {h} h.',
  ...
  'group.settings.age_gate': 'Account age floor',
  'group.settings.age_gate.hint': 'Accounts younger than the floor can read but not post. Blunts spam from throwaway accounts.',
  'group.settings.age_gate.h': '{h} h',
  'group.settings.age_gate.d': '{d} d',
  'chat.age_gate.wait': 'New accounts cannot post here yet. Yours can in ~{h} h.',
