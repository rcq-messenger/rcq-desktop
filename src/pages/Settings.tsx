...
export function Settings() {
  ...
  return (
    // ⚠⚠ The page itself must not be the scroller (#839). On Linux the desktop
    // build runs WebKitGTK, where the wheel moves an inner `overflow-y-auto`
    ...
    <div className="relative h-screen [height:100dvh] pt-[var(--rcq-top-inset)] flex flex-col bg-surface-dim overflow-hidden">
      ...
      <main className="flex-1 min-h-0 overflow-y-auto overscroll-contain w-full max-w-2xl mx-auto px-4 py-6 pt-[calc(3.5rem+1.5rem)] space-y-6">
        {!group && (
        <Link
          to="/profile"
